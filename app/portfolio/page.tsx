    ...
    <div className="mt-[--navbar-height]">
      <div className="py-20 px-4 bg-[url('/assets/images/header-bg.png')] bg-no-repeat bg-cover bg-center text-[--white] mb-20">
        <div className="mx-auto max-w-page">
          ...
          <p className="text-center my-10 text-xl max-w-prose px-9 py-4 mx-auto font-bold relative before:absolute before:border-t-2 before:border-l-2 before:border-[--white] before:w-12 before:h-12 before:top-0 before:left-0 after:absolute after:border-b-2 after:border-r-2 after:border-[--white] after:w-12 after:h-12 after:bottom-0 after:right-0">
      ...
      <div className="px-4 mx-auto max-w-page">
        <section>
          <div className="py-4 mb-10">
            <h2 className="text-2xl">WEBSITES</h2>
          </div>
          <div className="flex flex-col gap-20 items-center">
            <div className="border-2 border-[--black] rounded-lg bg-gradient-to-br from-purple-900 via-[--purple] to-purple-900 text-white shadow-2xl">
            ...
            <div className="border-2 border-[--black] rounded-lg bg-gradient-to-tr from-purple-900 via-[--purple] to-purple-900 text-white shadow-2xl">
              <div className="text-xl py-4 my-4 bg-[--white] border-l-0 border-r-0 border-t-2 border-b-2 border-[--black] pl-4 text-[--black]">
                XPRT Home
              </div>
            ...
            <div className="border-2 border-[--black] rounded-lg bg-gradient-to-tl from-purple-900 via-[--purple] to-purple-900 text-white shadow-2xl">
              <div className="text-xl py-4 my-4 bg-[--white] border-l-0 border-r-0 border-t-2 border-b-2 border-[--black] pl-4 text-[--black]">
