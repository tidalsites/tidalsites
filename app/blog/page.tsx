...
export default function BlogPage() {
  ...
  return (
    <section className="mt-[--navbar-height] min-h-screen max-w-page mx-auto py-8 px-4 | 2xl:px-0">
      ...
      <ul>
        <li onClick={() => navigateToArticle("/blog/why-your-website-is-slow")}>
          <BlogCard
            img={slowWebsite}
            alt="Slow website"
...
const BlogCard = ({ img, alt, title, description }: BlogCardProps) => {
  return (
    <div className="rounded-3xl shadow-[0_0_20px_-10px_rgba(0,200,255,.25)] p-4 bg-[rgba(0,0,0,.5)] backdrop-filter backdrop-blur-[5px] text-[--white] max-w-[400px] outline outline-2 outline-[--theme]">
