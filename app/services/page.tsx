  ...
  return (
    <div className="mt-[--navbar-height]">
      <div className="py-20 px-4">
        ...
        <p className="max-w-[50ch] px-9 py-4 mx-auto mt-10 font-bold text-xl relative before:absolute before:border-t-2 before:border-l-2 before:border-[--purple] before:w-12 before:h-12 before:top-0 before:left-0 after:absolute after:border-b-2 after:border-r-2 after:border-[--purple] after:w-12 after:h-12 after:bottom-0 after:right-0">
      ...
      <div>
        <div className="mx-4 mb-20 bg-gradient-to-bl from-orange-100 to-orange-200 border-2 border-[--black] rounded-lg shadow-lg">
