        ...
        <div className="mx-auto max-w-[65ch] leading-6">
          <section className="py-8 mx-4">
            <div>
              ...
              <p>
                ...
                solutions that cater to your specific needs. Whether you&apos;re
                a startup, small business, or established enterprise, we have
                the expertise to deliver high-quality designs that showcase your
          ...
          <section className="py-8 mx-4">
            ...
            <p>
              ...
              security monitoring, so you can focus on growing your business
              with peace of mind.
            </p>
          </section>
          <section className="py-8 mx-4">
            ...
            <p>
              ...
              practices right from the start. Our SEO-friendly web design
              ensures that your site is search engine optimized, helping you
          ...
          <section className="py-8 mx-4">
            ...
            <p>
              ...
              providing a smooth and engaging user experience across all
              devices.
            </p>
          </section>
          <section className="py-8 mx-4">
            ...
            <p>
              Join our growing list of satisfied clients who have experienced
              the Tidal Sites difference. Discover the power of web design that
